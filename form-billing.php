...
<script>
	...
	// 	btn.innerHTML = "ΣΤΟΙΧΕΙΑ ΑΠΟ TAXIS";
	// 	btn.type = "button";
	// 	btn.name = "TAXIS";
	// 	document.getElementById("afm_field_field").appendChild(btn);
	// }
...
jQuery( "input[name='billing_timologio'][value='0']" ).prop('checked',true);
</script>
